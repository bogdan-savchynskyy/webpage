...
To fix it in cmake/modules/FindHDF6.cmake in the line:
...
4) CPLEX ILP solver (academic license only !). Read here how to register and download it:
...
Select Grouped and Advanced in the top-right corner.
...
and run Configure. Read the output errors. Most probably, you will be asked to rpovide path to the CPLEX/CONCERT library. Do it like in this picture:
